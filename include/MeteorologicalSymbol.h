...
namespace woml
{
  ...
  public:
	MeteorologicalSymbol();
       ...
       typedef std::list<std::pair<std::string,std::pair<std::string,std::string> > > definitionReferenceList;
	void addDefinitionReference(const std::string & theScheme,const std::string & theDefinitionReference);
	...
	static std::string symbolDefinition(const DefinitionReferences_const_iterator & it,std::string & theSymbolCode);

       typedef std::list<std::pair<std::string,std::string> > localizedSymbolNameList;
	void addLocalizedSymbolName(const std::string & theLanguage,const std::string & theLocalizedSymbolName);
